...
class file_fuzzer:
    ...
    def mutate_file( self ):
        ...
        # The fuzzing meat and potatoes, really simple take a random test case and apply it to a random position in the file
        ...
        # Apply it to the buffer, we are just splicing in our fuzz data
...
if __name__ == "__main__":
    ...
    # This is the path to the document parser and the filename extension to use
    try:
